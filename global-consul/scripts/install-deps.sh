...
curl -Lfs https://github.com/hashicorp/consul-replicate/releases/download/v0.2.0/consul-replicate_0.2.0_linux_amd64.tar.gz > /tmp/consul-replicate.tar.gz
tar -xvf /tmp/consul-replicate.tar.gz
mv /tmp/consul-replicate_*_linux_amd64/consul-replicate /usr/local/bin/consul-replicate
